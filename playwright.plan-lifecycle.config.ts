...
export default defineConfig({
  testDir: "./tests",
  testMatch: "plan-lifecycle.spec.ts",
  timeout: 30_000,
  ...
  projects: [{ name: "http", use: { ...devices["Desktop Chrome"], channel: "chrome" } }],
  webServer: [
    {
    ...
    },
    {
      ...
      env: { "VITE_945_AUTH_ENABLED": "false", "VITE_945_REFERENCE_DATE": "2026-07-26" },
      reuseExistingServer: false,
      timeout: 60_000
    }
  ]
